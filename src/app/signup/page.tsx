    ...
    return (
      <Shell nav={<MinimalNav />} toolbar={<PreAuthToolbar />} short>
        <div className="flex items-center justify-center min-h-[70vh] px-6 py-16">
          <div className="w-full max-w-sm p-8 rounded-2xl text-center animate-fade-in" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)' }}>
            <div className="text-4xl mb-4">📬</div>
            <h2 className="font-display text-22 mb-2" style={{ color: 'var(--text-primary)', fontFamily: 'Syne, sans-serif' }}>Check your email</h2>
        ...
        >
          ...
          <div className="space-y-2 mb-6">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all hover:opacity-80 disabled:opacity-60"
